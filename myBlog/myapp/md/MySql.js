...
var CONNECT_STR = "mongodb://10.9.160.216:27017/bk1719";
...
//findCount(db,collectionName,whereobj,showObj,callback){
//	db.collection(collectionName).find(whereobj,showObj).count(err,result)=>{
//		if(err){
//			console.log(err);
//		}else{
//			callback(result);
